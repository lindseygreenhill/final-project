...
# United States. this means that on average individuals are going from less
# vulnerable countries to more vulnerable countries
...
gsi_graph2 <- GSI_joined %>% filter(destination_country != "United States",
  ...
  annotate("text", x = -17.47, y = 9, label = "Mean = 9.47", color = "blue") +
  theme_classic()
